...
mask.join <- function(df.edge, 
  ...
  #' Report
  # Each second can process around 167 rows, 
  .time.estimate <- round(nrow(ta.clst) / 167, digits = 2)
  message("Row-wise Revision based on Given Mask...")
  print(paste0("Estimated Time: ", .time.estimate, " sec"))
